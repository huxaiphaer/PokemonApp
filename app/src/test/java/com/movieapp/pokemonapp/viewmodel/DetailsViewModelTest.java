...
public class DetailsViewModelTest {
    ...
    private PublicLiveData<DetailsModal> mLiveData;
    ...
    private Observer<DetailsModal> mObserver3;
    private LifecycleOwner mOwner4;
    private Lifecycle mLifecycle4;
    private Observer<DetailsModal> mObserver4;
    ...
    public void testObserverToggle() {
        Observer<DetailsModal> observer = (Observer<DetailsModal>) mock(Observer.class);
